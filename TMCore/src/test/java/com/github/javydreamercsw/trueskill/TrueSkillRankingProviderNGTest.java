...
public class TrueSkillRankingProviderNGTest {
  ...
  public void testMatch() throws Exception {
    ...
    TeamInterface[] teams = new TeamInterface[] {new Team(1, p1), new Team(2, p2)};
    ...
    teams = new TeamInterface[] {new Team(3, p3), new Team(4, p4)};
    ...
    quality =
        p.getCalculator()
            .calculateMatchQuality(
                p.getGameInfo(),
                de.gesundkrank.jskills.Team.concat(teamList.subList(2, 4).toArray(new ITeam[0])));
    ...
    teams =
        new TeamInterface[] {new Team(1, p1), new Team(2, p2), new Team(3, p3), new Team(4, p4)};
