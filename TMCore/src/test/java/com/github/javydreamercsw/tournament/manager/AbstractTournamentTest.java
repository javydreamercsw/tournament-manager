...
public class AbstractTournamentTest {
  private static final Logger LOG = Logger.getLogger(AbstractTournamentTest.class.getName());
  ...
  public void testGetRandomWithExclusion() {
    ...
    System.out.println(
        MessageFormat.format("{0} tries excluding: {1}", tries, printArray(exclude)));
