...
public class RankingList extends TMView {
  ...
  public RankingList() {
    ...
    rankings.addColumn(this::getRowIndex).setWidth("2em").setResizable(true);
    rankings.addColumn(this::getTeam).setHeader("Team").setWidth("4em").setResizable(true);
    rankings.addColumn(TeamHasFormatRecord::getPoints).setHeader("Points").setWidth("4em");
    rankings.addColumn(TeamHasFormatRecord::getMean).setHeader("Mean").setWidth("6em");
    rankings
        .addColumn(TeamHasFormatRecord::getStandardDeviation)
