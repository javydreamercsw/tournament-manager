...
public class TestTournamentFormat extends AbstractTournament implements TournamentInterface {
  ...
  public TournamentInterface createTournament(
    ...
    TestTournamentFormat dummy = new TestTournamentFormat(winPoints, lossPoints, drawPoints, true);
