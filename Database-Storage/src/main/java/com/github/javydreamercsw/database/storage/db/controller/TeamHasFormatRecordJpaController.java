...
public class TeamHasFormatRecordJpaController extends AbstractController implements Serializable {
  ...
  public void create(TeamHasFormatRecord teamHasFormatRecord)
    ...
    teamHasFormatRecord
        .getTeamHasFormatRecordPK()
        .setFormatGameId(teamHasFormatRecord.getFormat().getFormatPK().getGameId());
    teamHasFormatRecord
        .getTeamHasFormatRecordPK()
        .setFormatId(teamHasFormatRecord.getFormat().getFormatPK().getId());
    ...
    try {
      ...
      if (findTeamHasFormatRecord(teamHasFormatRecord.getTeamHasFormatRecordPK()) != null) {
        throw new PreexistingEntityException(
            "TeamHasFormatRecord " + teamHasFormatRecord + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(TeamHasFormatRecord teamHasFormatRecord)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      TeamHasFormatRecord persistentTeamHasFormatRecord =
          em.find(TeamHasFormatRecord.class, teamHasFormatRecord.getTeamHasFormatRecordPK());
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findTeamHasFormatRecord(id) == null) {
          throw new NonexistentEntityException(
              "The teamHasFormatRecord with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(TeamHasFormatRecordPK id) throws NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The teamHasFormatRecord with id " + id + " no longer exists.", enfe);
      }
      Format format = teamHasFormatRecord.getFormat();
      if (format != null) {
  ...
  private List<TeamHasFormatRecord> findTeamHasFormatRecordEntities(
