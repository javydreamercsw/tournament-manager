  ...
  public void create(Player player) {
    ...
    try {
      ...
      for (Team teamListTeamToAttach : player.getTeamList()) {
        teamListTeamToAttach =
            em.getReference(teamListTeamToAttach.getClass(), teamListTeamToAttach.getId());
  ...
  public void edit(Player player) throws NonexistentEntityException, Exception {
    ...
    try {
      ...
      for (Team teamListNewTeamToAttach : teamListNew) {
        teamListNewTeamToAttach =
            em.getReference(teamListNewTeamToAttach.getClass(), teamListNewTeamToAttach.getId());
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The player with id " + id + " no longer exists.", enfe);
      }
