...
public class TeamJpaController extends AbstractController implements Serializable {
  ...
  public void create(Team team) {
    ...
    try {
      ...
      for (Player playerListPlayerToAttach : team.getPlayerList()) {
        playerListPlayerToAttach =
            em.getReference(playerListPlayerToAttach.getClass(), playerListPlayerToAttach.getId());
      ...
      for (MatchHasTeam matchHasTeamListMatchHasTeamToAttach : team.getMatchHasTeamList()) {
        matchHasTeamListMatchHasTeamToAttach =
            em.getReference(
                matchHasTeamListMatchHasTeamToAttach.getClass(),
      ...
      for (TournamentHasTeam tournamentHasTeamListTournamentHasTeamToAttach :
          team.getTournamentHasTeamList()) {
        tournamentHasTeamListTournamentHasTeamToAttach =
            em.getReference(
                tournamentHasTeamListTournamentHasTeamToAttach.getClass(),
                tournamentHasTeamListTournamentHasTeamToAttach.getTournamentHasTeamPK());
      ...
      for (TeamHasFormatRecord teamHasFormatRecordListTeamHasFormatRecordToAttach :
          team.getTeamHasFormatRecordList()) {
        teamHasFormatRecordListTeamHasFormatRecordToAttach =
            em.getReference(
                teamHasFormatRecordListTeamHasFormatRecordToAttach.getClass(),
                teamHasFormatRecordListTeamHasFormatRecordToAttach.getTeamHasFormatRecordPK());
      ...
      for (MatchHasTeam matchHasTeamListMatchHasTeam : team.getMatchHasTeamList()) {
        ...
        if (oldTeamOfMatchHasTeamListMatchHasTeam != null) {
          oldTeamOfMatchHasTeamListMatchHasTeam
              .getMatchHasTeamList()
              .remove(matchHasTeamListMatchHasTeam);
          oldTeamOfMatchHasTeamListMatchHasTeam = em.merge(oldTeamOfMatchHasTeamListMatchHasTeam);
        }
      }
      for (TournamentHasTeam tournamentHasTeamListTournamentHasTeam :
          team.getTournamentHasTeamList()) {
        Team oldTeamOfTournamentHasTeamListTournamentHasTeam =
            tournamentHasTeamListTournamentHasTeam.getTeam();
        ...
        if (oldTeamOfTournamentHasTeamListTournamentHasTeam != null) {
          oldTeamOfTournamentHasTeamListTournamentHasTeam
              .getTournamentHasTeamList()
              .remove(tournamentHasTeamListTournamentHasTeam);
          oldTeamOfTournamentHasTeamListTournamentHasTeam =
              em.merge(oldTeamOfTournamentHasTeamListTournamentHasTeam);
        }
      }
      for (TeamHasFormatRecord teamHasFormatRecordListTeamHasFormatRecord :
          team.getTeamHasFormatRecordList()) {
        Team oldTeamOfTeamHasFormatRecordListTeamHasFormatRecord =
            teamHasFormatRecordListTeamHasFormatRecord.getTeam();
        teamHasFormatRecordListTeamHasFormatRecord.setTeam(team);
        teamHasFormatRecordListTeamHasFormatRecord =
            em.merge(teamHasFormatRecordListTeamHasFormatRecord);
        if (oldTeamOfTeamHasFormatRecordListTeamHasFormatRecord != null) {
          oldTeamOfTeamHasFormatRecordListTeamHasFormatRecord
              .getTeamHasFormatRecordList()
              .remove(teamHasFormatRecordListTeamHasFormatRecord);
          oldTeamOfTeamHasFormatRecordListTeamHasFormatRecord =
              em.merge(oldTeamOfTeamHasFormatRecordListTeamHasFormatRecord);
        }
      }
  ...
  public void edit(Team team) throws IllegalOrphanException, NonexistentEntityException, Exception {
    ...
    try {
      ...
      List<TeamHasFormatRecord> teamHasFormatRecordListOld =
          persistentTeam.getTeamHasFormatRecordList();
      ...
      for (MatchHasTeam matchHasTeamListOldMatchHasTeam : matchHasTeamListOld) {
        if (!matchHasTeamListNew.contains(matchHasTeamListOldMatchHasTeam)) {
          ...
          illegalOrphanMessages.add(
              "You must retain MatchHasTeam "
                  + matchHasTeamListOldMatchHasTeam
                  + " since its team field is not nullable.");
        }
      }
      for (TournamentHasTeam tournamentHasTeamListOldTournamentHasTeam : tournamentHasTeamListOld) {
        if (!tournamentHasTeamListNew.contains(tournamentHasTeamListOldTournamentHasTeam)) {
          ...
          illegalOrphanMessages.add(
              "You must retain TournamentHasTeam "
                  + tournamentHasTeamListOldTournamentHasTeam
                  + " since its team field is not nullable.");
        }
      }
      for (TeamHasFormatRecord teamHasFormatRecordListOldTeamHasFormatRecord :
          teamHasFormatRecordListOld) {
        if (!teamHasFormatRecordListNew.contains(teamHasFormatRecordListOldTeamHasFormatRecord)) {
          if (illegalOrphanMessages == null) {
            illegalOrphanMessages = new ArrayList<>();
          }
          illegalOrphanMessages.add(
              "You must retain TeamHasFormatRecord "
                  + teamHasFormatRecordListOldTeamHasFormatRecord
                  + " since its team field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (Player playerListNewPlayerToAttach : playerListNew) {
        playerListNewPlayerToAttach =
            em.getReference(
                playerListNewPlayerToAttach.getClass(), playerListNewPlayerToAttach.getId());
      ...
      for (MatchHasTeam matchHasTeamListNewMatchHasTeamToAttach : matchHasTeamListNew) {
        matchHasTeamListNewMatchHasTeamToAttach =
            em.getReference(
                matchHasTeamListNewMatchHasTeamToAttach.getClass(),
                matchHasTeamListNewMatchHasTeamToAttach.getMatchHasTeamPK());
      ...
      for (TournamentHasTeam tournamentHasTeamListNewTournamentHasTeamToAttach :
          tournamentHasTeamListNew) {
        tournamentHasTeamListNewTournamentHasTeamToAttach =
            em.getReference(
                tournamentHasTeamListNewTournamentHasTeamToAttach.getClass(),
                tournamentHasTeamListNewTournamentHasTeamToAttach.getTournamentHasTeamPK());
      ...
      for (TeamHasFormatRecord teamHasFormatRecordListNewTeamHasFormatRecordToAttach :
          teamHasFormatRecordListNew) {
        teamHasFormatRecordListNewTeamHasFormatRecordToAttach =
            em.getReference(
                teamHasFormatRecordListNewTeamHasFormatRecordToAttach.getClass(),
                teamHasFormatRecordListNewTeamHasFormatRecordToAttach.getTeamHasFormatRecordPK());
        attachedTeamHasFormatRecordListNew.add(
            teamHasFormatRecordListNewTeamHasFormatRecordToAttach);
      }
      ...
      for (MatchHasTeam matchHasTeamListNewMatchHasTeam : matchHasTeamListNew) {
        if (!matchHasTeamListOld.contains(matchHasTeamListNewMatchHasTeam)) {
          ...
          if (oldTeamOfMatchHasTeamListNewMatchHasTeam != null
              && !oldTeamOfMatchHasTeamListNewMatchHasTeam.equals(team)) {
            oldTeamOfMatchHasTeamListNewMatchHasTeam
                .getMatchHasTeamList()
                .remove(matchHasTeamListNewMatchHasTeam);
            oldTeamOfMatchHasTeamListNewMatchHasTeam =
                em.merge(oldTeamOfMatchHasTeamListNewMatchHasTeam);
          }
        }
      }
      for (TournamentHasTeam tournamentHasTeamListNewTournamentHasTeam : tournamentHasTeamListNew) {
        if (!tournamentHasTeamListOld.contains(tournamentHasTeamListNewTournamentHasTeam)) {
          Team oldTeamOfTournamentHasTeamListNewTournamentHasTeam =
              tournamentHasTeamListNewTournamentHasTeam.getTeam();
          tournamentHasTeamListNewTournamentHasTeam.setTeam(team);
          tournamentHasTeamListNewTournamentHasTeam =
              em.merge(tournamentHasTeamListNewTournamentHasTeam);
          if (oldTeamOfTournamentHasTeamListNewTournamentHasTeam != null
              && !oldTeamOfTournamentHasTeamListNewTournamentHasTeam.equals(team)) {
            oldTeamOfTournamentHasTeamListNewTournamentHasTeam
                .getTournamentHasTeamList()
                .remove(tournamentHasTeamListNewTournamentHasTeam);
            oldTeamOfTournamentHasTeamListNewTournamentHasTeam =
                em.merge(oldTeamOfTournamentHasTeamListNewTournamentHasTeam);
          }
        }
      }
      for (TeamHasFormatRecord teamHasFormatRecordListNewTeamHasFormatRecord :
        ...
        if (!teamHasFormatRecordListOld.contains(teamHasFormatRecordListNewTeamHasFormatRecord)) {
          Team oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord =
              teamHasFormatRecordListNewTeamHasFormatRecord.getTeam();
          teamHasFormatRecordListNewTeamHasFormatRecord.setTeam(team);
          teamHasFormatRecordListNewTeamHasFormatRecord =
              em.merge(teamHasFormatRecordListNewTeamHasFormatRecord);
          if (oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord != null
              && !oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord.equals(team)) {
            oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord
                .getTeamHasFormatRecordList()
                .remove(teamHasFormatRecordListNewTeamHasFormatRecord);
            oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord =
                em.merge(oldTeamOfTeamHasFormatRecordListNewTeamHasFormatRecord);
          }
        }
      }
      em.getTransaction().commit();
    ...
    try {
      ...
      for (MatchHasTeam matchHasTeamListOrphanCheckMatchHasTeam : matchHasTeamListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This Team ("
                + team
                + ") cannot be destroyed since the MatchHasTeam "
                + matchHasTeamListOrphanCheckMatchHasTeam
                + " in its matchHasTeamList field has a non-nullable team field.");
      }
      List<TournamentHasTeam> tournamentHasTeamListOrphanCheck = team.getTournamentHasTeamList();
      for (TournamentHasTeam tournamentHasTeamListOrphanCheckTournamentHasTeam :
        ...
        illegalOrphanMessages.add(
            "This Team ("
                + team
                + ") cannot be destroyed since the TournamentHasTeam "
                + tournamentHasTeamListOrphanCheckTournamentHasTeam
                + " in its tournamentHasTeamList field has a non-nullable team field.");
      }
      List<TeamHasFormatRecord> teamHasFormatRecordListOrphanCheck =
          team.getTeamHasFormatRecordList();
      for (TeamHasFormatRecord teamHasFormatRecordListOrphanCheckTeamHasFormatRecord :
          teamHasFormatRecordListOrphanCheck) {
        if (illegalOrphanMessages == null) {
          illegalOrphanMessages = new ArrayList<>();
        }
        illegalOrphanMessages.add(
            "This Team ("
                + team
                + ") cannot be destroyed since the TeamHasFormatRecord "
                + teamHasFormatRecordListOrphanCheckTeamHasFormatRecord
                + " in its teamHasFormatRecordList field has a non-nullable team field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
