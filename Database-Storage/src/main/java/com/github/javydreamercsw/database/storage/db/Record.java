...
public class Record implements Serializable {
  ...
  @NotNull @Column(name = "wins")
  private int wins;

  @Basic(optional = false)
  @NotNull @Column(name = "loses")
  private int loses;

  @Basic(optional = false)
  @NotNull @Column(name = "draws")
  private int draws;
  ...
  @JoinTable(
      name = "tournament_has_team_has_record",
      joinColumns = {
      ...
      inverseJoinColumns = {
        @JoinColumn(
            name = "tournament_has_team_tournament_id",
  ...
  public String toString() {
    return "com.github.javydreamercsw.database.storage.db.Record[ recordPK=" + recordPK + " ]";
  }
