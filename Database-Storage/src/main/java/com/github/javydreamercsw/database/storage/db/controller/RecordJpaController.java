  ...
  public void create(Record record) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      for (TournamentHasTeam tournamentHasTeamListTournamentHasTeamToAttach :
          record.getTournamentHasTeamList()) {
  ...
  public void edit(Record record) throws NonexistentEntityException, Exception {
    ...
    try {
      ...
      List<TournamentHasTeam> tournamentHasTeamListOld =
          persistentRecord.getTournamentHasTeamList();
      ...
      for (TournamentHasTeam tournamentHasTeamListOldTournamentHasTeam : tournamentHasTeamListOld) {
        if (!tournamentHasTeamListNew.contains(tournamentHasTeamListOldTournamentHasTeam)) {
          ...
          tournamentHasTeamListOldTournamentHasTeam =
              em.merge(tournamentHasTeamListOldTournamentHasTeam);
        }
      }
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The record with id " + id + " no longer exists.", enfe);
      }
      Game game = record.getGame();
      if (game != null) {
