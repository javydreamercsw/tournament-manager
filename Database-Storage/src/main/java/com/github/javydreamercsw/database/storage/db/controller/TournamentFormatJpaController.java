...
public class TournamentFormatJpaController extends AbstractController implements Serializable {
  ...
  public void create(TournamentFormat tournamentFormat)
    ...
    try {
      ...
      for (Tournament tournamentListTournament : tournamentFormat.getTournamentList()) {
        TournamentFormat oldTournamentFormatOfTournamentListTournament =
            tournamentListTournament.getTournamentFormat();
        ...
        if (oldTournamentFormatOfTournamentListTournament != null) {
          oldTournamentFormatOfTournamentListTournament
              .getTournamentList()
              .remove(tournamentListTournament);
          oldTournamentFormatOfTournamentListTournament =
              em.merge(oldTournamentFormatOfTournamentListTournament);
        }
      }
      ...
      if (tournamentFormat.getId() != null
        ...
        throw new PreexistingEntityException(
            "TournamentFormat " + tournamentFormat + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(TournamentFormat tournamentFormat)
      throws IllegalOrphanException, NonexistentEntityException, Exception {
    EntityManager em = null;
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      TournamentFormat persistentTournamentFormat =
          em.find(TournamentFormat.class, tournamentFormat.getId());
        ...
        if (!tournamentListNew.contains(tournamentListOldTournament)) {
          ...
          illegalOrphanMessages.add(
              "You must retain Tournament "
                  ...
                  + " since its tournamentFormat field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (Tournament tournamentListNewTournament : tournamentListNew) {
        if (!tournamentListOld.contains(tournamentListNewTournament)) {
          TournamentFormat oldTournamentFormatOfTournamentListNewTournament =
              tournamentListNewTournament.getTournamentFormat();
          ...
          if (oldTournamentFormatOfTournamentListNewTournament != null
              && !oldTournamentFormatOfTournamentListNewTournament.equals(tournamentFormat)) {
            oldTournamentFormatOfTournamentListNewTournament
                .getTournamentList()
                .remove(tournamentListNewTournament);
            oldTournamentFormatOfTournamentListNewTournament =
                em.merge(oldTournamentFormatOfTournamentListNewTournament);
          }
        }
      }
      em.getTransaction().commit();
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findTournamentFormat(id) == null) {
          throw new NonexistentEntityException(
              "The tournamentFormat with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The tournamentFormat with id " + id + " no longer exists.", enfe);
      }
      List<String> illegalOrphanMessages = null;
      ...
      for (Tournament tournamentListOrphanCheckTournament : tournamentListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This TournamentFormat ("
                ...
                + " in its tournamentList field has a non-nullable tournamentFormat field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
  ...
  private List<TournamentFormat> findTournamentFormatEntities(
