...
public class TournamentJpaController extends AbstractController implements Serializable {
  ...
  public void create(Tournament tournament) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      for (TournamentHasTeam tournamentHasTeamListTournamentHasTeamToAttach :
          tournament.getTournamentHasTeamList()) {
      ...
      for (Round roundListRoundToAttach : tournament.getRoundList()) {
        roundListRoundToAttach =
            em.getReference(roundListRoundToAttach.getClass(), roundListRoundToAttach.getRoundPK());
      ...
      for (TournamentHasTeam tournamentHasTeamListTournamentHasTeam :
          tournament.getTournamentHasTeamList()) {
        Tournament oldTournamentOfTournamentHasTeamListTournamentHasTeam =
            tournamentHasTeamListTournamentHasTeam.getTournament();
        ...
        if (oldTournamentOfTournamentHasTeamListTournamentHasTeam != null) {
          oldTournamentOfTournamentHasTeamListTournamentHasTeam
              .getTournamentHasTeamList()
              .remove(tournamentHasTeamListTournamentHasTeam);
          oldTournamentOfTournamentHasTeamListTournamentHasTeam =
              em.merge(oldTournamentOfTournamentHasTeamListTournamentHasTeam);
        }
      }
  ...
  public void edit(Tournament tournament)
    ...
    try {
      ...
      List<TournamentHasTeam> tournamentHasTeamListOld =
          persistentTournament.getTournamentHasTeamList();
        ...
        if (!tournamentHasTeamListNew.contains(tournamentHasTeamListOldTournamentHasTeam)) {
          ...
          illegalOrphanMessages.add(
              "You must retain TournamentHasTeam "
                  ...
                  + " since its tournament field is not nullable.");
        }
      }
      ...
      if (tournamentFormatNew != null) {
        tournamentFormatNew =
            em.getReference(tournamentFormatNew.getClass(), tournamentFormatNew.getId());
      ...
      for (Round roundListNewRoundToAttach : roundListNew) {
        roundListNewRoundToAttach =
            em.getReference(
                roundListNewRoundToAttach.getClass(), roundListNewRoundToAttach.getRoundPK());
      ...
      for (TournamentHasTeam tournamentHasTeamListNewTournamentHasTeam : tournamentHasTeamListNew) {
        if (!tournamentHasTeamListOld.contains(tournamentHasTeamListNewTournamentHasTeam)) {
          Tournament oldTournamentOfTournamentHasTeamListNewTournamentHasTeam =
              tournamentHasTeamListNewTournamentHasTeam.getTournament();
          ...
          if (oldTournamentOfTournamentHasTeamListNewTournamentHasTeam != null
              && !oldTournamentOfTournamentHasTeamListNewTournamentHasTeam.equals(tournament)) {
            oldTournamentOfTournamentHasTeamListNewTournamentHasTeam
                .getTournamentHasTeamList()
                .remove(tournamentHasTeamListNewTournamentHasTeam);
            oldTournamentOfTournamentHasTeamListNewTournamentHasTeam =
                em.merge(oldTournamentOfTournamentHasTeamListNewTournamentHasTeam);
          }
        }
      }
      for (Round roundListNewRound : roundListNew) {
        if (!roundListOld.contains(roundListNewRound)) {
          ...
          if (oldTournamentOfRoundListNewRound != null
              && !oldTournamentOfRoundListNewRound.equals(tournament)) {
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findTournament(id) == null) {
          throw new NonexistentEntityException(
              "The tournament with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(TournamentPK id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The tournament with id " + id + " no longer exists.", enfe);
      }
      List<String> illegalOrphanMessages = null;
      List<TournamentHasTeam> tournamentHasTeamListOrphanCheck =
          tournament.getTournamentHasTeamList();
      for (TournamentHasTeam tournamentHasTeamListOrphanCheckTournamentHasTeam :
        ...
        illegalOrphanMessages.add(
            "This Tournament ("
                ...
                + " in its tournamentHasTeamList field has a non-nullable tournament field.");
      }
      ...
      for (Round roundListOrphanCheckRound : roundListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This Tournament ("
                + tournament
                + ") cannot be destroyed since the Round "
                + roundListOrphanCheckRound
                + " in its roundList field has a non-nullable tournament field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
