...
public class MatchEntryJpaController extends AbstractController implements Serializable {
  ...
  public void create(MatchEntry matchEntry) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      for (MatchHasTeam matchHasTeamListMatchHasTeam : matchEntry.getMatchHasTeamList()) {
        MatchEntry oldMatchEntryOfMatchHasTeamListMatchHasTeam =
            matchHasTeamListMatchHasTeam.getMatchEntry();
        ...
        if (oldMatchEntryOfMatchHasTeamListMatchHasTeam != null) {
          oldMatchEntryOfMatchHasTeamListMatchHasTeam
              .getMatchHasTeamList()
              .remove(matchHasTeamListMatchHasTeam);
          oldMatchEntryOfMatchHasTeamListMatchHasTeam =
              em.merge(oldMatchEntryOfMatchHasTeamListMatchHasTeam);
        }
      }
  ...
  public void edit(MatchEntry matchEntry)
    ...
    try {
        ...
        if (!matchHasTeamListNew.contains(matchHasTeamListOldMatchHasTeam)) {
          ...
          illegalOrphanMessages.add(
              "You must retain MatchHasTeam "
                  ...
                  + " since its matchEntry field is not nullable.");
        }
      }
      if (illegalOrphanMessages != null) {
      ...
      for (MatchHasTeam matchHasTeamListNewMatchHasTeam : matchHasTeamListNew) {
        if (!matchHasTeamListOld.contains(matchHasTeamListNewMatchHasTeam)) {
          MatchEntry oldMatchEntryOfMatchHasTeamListNewMatchHasTeam =
              matchHasTeamListNewMatchHasTeam.getMatchEntry();
          ...
          if (oldMatchEntryOfMatchHasTeamListNewMatchHasTeam != null
              && !oldMatchEntryOfMatchHasTeamListNewMatchHasTeam.equals(matchEntry)) {
            oldMatchEntryOfMatchHasTeamListNewMatchHasTeam
                .getMatchHasTeamList()
                .remove(matchHasTeamListNewMatchHasTeam);
            oldMatchEntryOfMatchHasTeamListNewMatchHasTeam =
                em.merge(oldMatchEntryOfMatchHasTeamListNewMatchHasTeam);
          }
        }
      }
      em.getTransaction().commit();
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findMatchEntry(id) == null) {
          throw new NonexistentEntityException(
              "The matchEntry with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(MatchEntryPK id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The matchEntry with id " + id + " no longer exists.", enfe);
      }
      List<String> illegalOrphanMessages = null;
      ...
      for (MatchHasTeam matchHasTeamListOrphanCheckMatchHasTeam : matchHasTeamListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This MatchEntry ("
                ...
                + " in its matchHasTeamList field has a non-nullable matchEntry field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
