...
public class TournamentHasTeamJpaController extends AbstractController implements Serializable {
  ...
  public void create(TournamentHasTeam tournamentHasTeam)
    ...
    tournamentHasTeam
        .getTournamentHasTeamPK()
        .setTournamentId(tournamentHasTeam.getTournament().getTournamentPK().getId());
    ...
    try {
      ...
      for (Record recordListRecordToAttach : tournamentHasTeam.getRecordList()) {
        recordListRecordToAttach =
            em.getReference(
                recordListRecordToAttach.getClass(), recordListRecordToAttach.getRecordPK());
      ...
      if (findTournamentHasTeam(tournamentHasTeam.getTournamentHasTeamPK()) != null) {
        throw new PreexistingEntityException(
            "TournamentHasTeam " + tournamentHasTeam + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(TournamentHasTeam tournamentHasTeam)
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      TournamentHasTeam persistentTournamentHasTeam =
          em.find(TournamentHasTeam.class, tournamentHasTeam.getTournamentHasTeamPK());
      ...
      for (Record recordListNewRecordToAttach : recordListNew) {
        recordListNewRecordToAttach =
            em.getReference(
                recordListNewRecordToAttach.getClass(), recordListNewRecordToAttach.getRecordPK());
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findTournamentHasTeam(id) == null) {
          throw new NonexistentEntityException(
              "The tournamentHasTeam with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(TournamentHasTeamPK id) throws NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The tournamentHasTeam with id " + id + " no longer exists.", enfe);
      }
      Team team = tournamentHasTeam.getTeam();
      if (team != null) {
  ...
  private List<TournamentHasTeam> findTournamentHasTeamEntities(
