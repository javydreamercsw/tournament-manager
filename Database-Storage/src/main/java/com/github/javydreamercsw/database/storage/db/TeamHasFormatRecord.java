...
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "TeamHasFormatRecord.findAll", query = "SELECT t FROM TeamHasFormatRecord t"),
  @NamedQuery(
      name = "TeamHasFormatRecord.findByTeamId",
      query = "SELECT t FROM TeamHasFormatRecord t WHERE t.teamHasFormatRecordPK.teamId = :teamId"),
  @NamedQuery(
      name = "TeamHasFormatRecord.findByFormatId",
      query =
          "SELECT t FROM TeamHasFormatRecord t WHERE t.teamHasFormatRecordPK.formatId = :formatId"),
  @NamedQuery(
      name = "TeamHasFormatRecord.findByFormatGameId",
      query =
          "SELECT t FROM TeamHasFormatRecord t WHERE t.teamHasFormatRecordPK.formatGameId ="
              + " :formatGameId"),
  @NamedQuery(
      name = "TeamHasFormatRecord.findByMean",
      query = "SELECT t FROM TeamHasFormatRecord t WHERE t.mean = :mean"),
  @NamedQuery(
      name = "TeamHasFormatRecord.findByStandardDeviation",
...
public class TeamHasFormatRecord implements Serializable {
  ...
  @NotNull @Column(name = "mean")
  private double mean;

  @Basic(optional = false)
  @NotNull @Column(name = "standard_deviation")
  private double standardDeviation;

  @Basic(optional = false)
  @NotNull @Column(name = "points")
  private int points;

  @EmbeddedId protected TeamHasFormatRecordPK teamHasFormatRecordPK;
  ...
  public TeamHasFormatRecord(
      TeamHasFormatRecordPK teamHasFormatRecordPK, double mean, double standardDeviation) {
    this.teamHasFormatRecordPK = teamHasFormatRecordPK;
    this.mean = mean;
  ...
  public boolean equals(Object object) {
    ...
    return !((this.teamHasFormatRecordPK == null && other.teamHasFormatRecordPK != null)
