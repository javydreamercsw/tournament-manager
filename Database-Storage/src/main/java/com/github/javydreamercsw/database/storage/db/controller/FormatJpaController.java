...
public class FormatJpaController extends AbstractController implements Serializable {
  ...
  public void create(Format format) throws PreexistingEntityException, Exception {
    ...
    try {
      ...
      for (MatchEntry matchEntryListMatchEntryToAttach : format.getMatchEntryList()) {
        matchEntryListMatchEntryToAttach =
            em.getReference(
                matchEntryListMatchEntryToAttach.getClass(),
                matchEntryListMatchEntryToAttach.getMatchEntryPK());
      ...
      for (Tournament tournamentListTournamentToAttach : format.getTournamentList()) {
        tournamentListTournamentToAttach =
            em.getReference(
                tournamentListTournamentToAttach.getClass(),
                tournamentListTournamentToAttach.getTournamentPK());
      ...
      for (TeamHasFormatRecord teamHasFormatRecordListTeamHasFormatRecordToAttach :
          format.getTeamHasFormatRecordList()) {
      ...
      for (TeamHasFormatRecord teamHasFormatRecordListTeamHasFormatRecord :
          format.getTeamHasFormatRecordList()) {
        Format oldFormatOfTeamHasFormatRecordListTeamHasFormatRecord =
            teamHasFormatRecordListTeamHasFormatRecord.getFormat();
        ...
        if (oldFormatOfTeamHasFormatRecordListTeamHasFormatRecord != null) {
          oldFormatOfTeamHasFormatRecordListTeamHasFormatRecord
              .getTeamHasFormatRecordList()
              .remove(teamHasFormatRecordListTeamHasFormatRecord);
          oldFormatOfTeamHasFormatRecordListTeamHasFormatRecord =
              em.merge(oldFormatOfTeamHasFormatRecordListTeamHasFormatRecord);
        }
      }
  ...
  public void edit(Format format)
    ...
    try {
      ...
      List<TeamHasFormatRecord> teamHasFormatRecordListOld =
          persistentFormat.getTeamHasFormatRecordList();
      ...
      for (MatchEntry matchEntryListOldMatchEntry : matchEntryListOld) {
        if (!matchEntryListNew.contains(matchEntryListOldMatchEntry)) {
          ...
          illegalOrphanMessages.add(
              "You must retain MatchEntry "
                  + matchEntryListOldMatchEntry
                  + " since its format field is not nullable.");
        }
      }
      for (Tournament tournamentListOldTournament : tournamentListOld) {
        if (!tournamentListNew.contains(tournamentListOldTournament)) {
          ...
          illegalOrphanMessages.add(
              "You must retain Tournament "
                  + tournamentListOldTournament
                  + " since its format field is not nullable.");
        }
      }
      ...
      for (MatchEntry matchEntryListNewMatchEntryToAttach : matchEntryListNew) {
        matchEntryListNewMatchEntryToAttach =
            em.getReference(
                matchEntryListNewMatchEntryToAttach.getClass(),
                matchEntryListNewMatchEntryToAttach.getMatchEntryPK());
      ...
      for (Tournament tournamentListNewTournamentToAttach : tournamentListNew) {
        tournamentListNewTournamentToAttach =
            em.getReference(
                tournamentListNewTournamentToAttach.getClass(),
                tournamentListNewTournamentToAttach.getTournamentPK());
      ...
      for (MatchEntry matchEntryListNewMatchEntry : matchEntryListNew) {
        if (!matchEntryListOld.contains(matchEntryListNewMatchEntry)) {
          ...
          if (oldFormatOfMatchEntryListNewMatchEntry != null
              && !oldFormatOfMatchEntryListNewMatchEntry.equals(format)) {
            oldFormatOfMatchEntryListNewMatchEntry
                .getMatchEntryList()
                .remove(matchEntryListNewMatchEntry);
            oldFormatOfMatchEntryListNewMatchEntry =
                em.merge(oldFormatOfMatchEntryListNewMatchEntry);
          }
        }
      }
      for (Tournament tournamentListNewTournament : tournamentListNew) {
        if (!tournamentListOld.contains(tournamentListNewTournament)) {
          ...
          if (oldFormatOfTournamentListNewTournament != null
              && !oldFormatOfTournamentListNewTournament.equals(format)) {
            oldFormatOfTournamentListNewTournament
                .getTournamentList()
                .remove(tournamentListNewTournament);
            oldFormatOfTournamentListNewTournament =
                em.merge(oldFormatOfTournamentListNewTournament);
          }
        }
      }
      for (TeamHasFormatRecord teamHasFormatRecordListNewTeamHasFormatRecord :
        ...
        if (!teamHasFormatRecordListOld.contains(teamHasFormatRecordListNewTeamHasFormatRecord)) {
          Format oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord =
              teamHasFormatRecordListNewTeamHasFormatRecord.getFormat();
          ...
          if (oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord != null
              && !oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord.equals(format)) {
            oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord
                .getTeamHasFormatRecordList()
                .remove(teamHasFormatRecordListNewTeamHasFormatRecord);
            oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord =
                em.merge(oldFormatOfTeamHasFormatRecordListNewTeamHasFormatRecord);
          }
        }
      }
      em.getTransaction().commit();
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The format with id " + id + " no longer exists.", enfe);
      }
      List<String> illegalOrphanMessages = null;
      ...
      for (MatchEntry matchEntryListOrphanCheckMatchEntry : matchEntryListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This Format ("
                + format
                + ") cannot be destroyed since the MatchEntry "
                + matchEntryListOrphanCheckMatchEntry
                + " in its matchEntryList field has a non-nullable format field.");
      }
      ...
      for (Tournament tournamentListOrphanCheckTournament : tournamentListOrphanCheck) {
        ...
        illegalOrphanMessages.add(
            "This Format ("
                + format
                + ") cannot be destroyed since the Tournament "
                + tournamentListOrphanCheckTournament
                + " in its tournamentList field has a non-nullable format field.");
      }
      ...
      for (TeamHasFormatRecord teamHasFormatRecordListOrphanCheckTeamHasFormatRecord :
        ...
        illegalOrphanMessages.add(
            "This Format ("
                ...
                + " in its teamHasFormatRecordList field has a non-nullable format field.");
      }
      if (illegalOrphanMessages != null) {
        throw new IllegalOrphanException(illegalOrphanMessages);
      }
