...
public class MatchHasTeamJpaController extends AbstractController implements Serializable {
  ...
  public void create(MatchHasTeam matchHasTeam) throws PreexistingEntityException, Exception {
    ...
    matchHasTeam
        .getMatchHasTeamPK()
        .setMatchEntryFormatId(matchHasTeam.getMatchEntry().getMatchEntryPK().getFormatId());
    matchHasTeam.getMatchHasTeamPK().setTeamId(matchHasTeam.getTeam().getId());
    matchHasTeam
        .getMatchHasTeamPK()
        .setMatchEntryId(matchHasTeam.getMatchEntry().getMatchEntryPK().getId());
    matchHasTeam
        .getMatchHasTeamPK()
        .setMatchEntryFormatGameId(
            matchHasTeam.getMatchEntry().getMatchEntryPK().getFormatGameId());
    ...
    try {
      ...
      if (findMatchHasTeam(matchHasTeam.getMatchHasTeamPK()) != null) {
        throw new PreexistingEntityException(
            "MatchHasTeam " + matchHasTeam + " already exists.", ex);
      }
      throw ex;
    } finally {
      if (em != null) {
  ...
  public void edit(MatchHasTeam matchHasTeam) throws NonexistentEntityException, Exception {
    ...
    try {
      em = getEntityManager();
      em.getTransaction().begin();
      MatchHasTeam persistentMatchHasTeam =
          em.find(MatchHasTeam.class, matchHasTeam.getMatchHasTeamPK());
      ...
      if (matchResultNew != null) {
        matchResultNew =
            em.getReference(matchResultNew.getClass(), matchResultNew.getMatchResultPK());
      ...
      if (msg == null || msg.isEmpty()) {
        ...
        if (findMatchHasTeam(id) == null) {
          throw new NonexistentEntityException(
              "The matchHasTeam with id " + id + " no longer exists.");
        }
      }
      throw ex;
    } finally {
  ...
  public void destroy(MatchHasTeamPK id) throws NonexistentEntityException {
    ...
    try {
      ...
      try {
        ...
        throw new NonexistentEntityException(
            "The matchHasTeam with id " + id + " no longer exists.", enfe);
      }
      MatchEntry matchEntry = matchHasTeam.getMatchEntry();
      if (matchEntry != null) {
  ...
  private List<MatchHasTeam> findMatchHasTeamEntities(
