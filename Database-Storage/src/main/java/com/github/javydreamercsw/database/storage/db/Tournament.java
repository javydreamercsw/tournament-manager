...
public class Tournament implements Serializable {
  ...
  @Basic(optional = false)
  @NotNull @Column(name = "winPoints")
  private int winPoints;

  @Basic(optional = false)
  @NotNull @Column(name = "drawPoints")
  private int drawPoints;

  @Basic(optional = false)
  @NotNull @Column(name = "lossPoints")
  private int lossPoints;

  @Basic(optional = false)
  @NotNull @Column(name = "startDate")
  ...
  @Basic(optional = false)
  @NotNull @Column(name = "signupDate")
  private LocalDateTime signupDate;

  @Basic(optional = false)
  @NotNull @Column(name = "signupTimeLimit")
  private int signupTimeLimit;

  @Basic(optional = false)
  @NotNull @Column(name = "roundTimeLimit")
  private int roundTimeLimit;

  @Basic(optional = false)
  @NotNull @Column(name = "noShowTimeLimit")
  private int noShowTimeLimit;

  private static final long serialVersionUID = -6583090940281361773L;
  @EmbeddedId protected TournamentPK tournamentPK;
  ...
  public boolean equals(Object object) {
    ...
    return !((this.tournamentPK == null && other.tournamentPK != null)
        || (this.tournamentPK != null && !this.tournamentPK.equals(other.tournamentPK)));
  }
