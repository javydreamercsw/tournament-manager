...
public class MatchResultTypeJpaController implements Serializable {
    ...
    public void create(MatchResultType matchResultType) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findMatchResultType(matchResultType.getId()) != null) {
                throw new PreexistingEntityException("MatchResultType " + matchResultType + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
