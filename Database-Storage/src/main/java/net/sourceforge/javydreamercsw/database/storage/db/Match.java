...
@NamedQueries(
  ...
  @NamedQuery(name = "Match.findById",
          query = "SELECT m FROM Match m WHERE m.matchPK.id = :id"),
  @NamedQuery(name = "Match.findByRoundId",
          query = "SELECT m FROM Match m WHERE m.matchPK.roundId = :roundId")
})
public class Match implements Serializable
{
  ...
  public boolean equals(Object object)
  {
    ...
    return !((this.matchPK == null && other.matchPK != null)
            || (this.matchPK != null && !this.matchPK.equals(other.matchPK)));
  }

  @Override
  public String toString()
  {
    return "net.sourceforge.javydreamercsw.database.storage.db.Match[ matchPK="
            + matchPK + " ]";
  }
