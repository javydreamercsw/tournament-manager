...
@NamedQueries({
    ...
    @NamedQuery(name = "TmId.findById", query = "SELECT v FROM TmId v WHERE v.id = :id"),
    @NamedQuery(name = "TmId.findByLastId", query = "SELECT v FROM TmId v WHERE v.lastId = :lastId"),
    @NamedQuery(name = "TmId.findByTableName", query = "SELECT v FROM TmId v WHERE v.tableName = :tableName")})
