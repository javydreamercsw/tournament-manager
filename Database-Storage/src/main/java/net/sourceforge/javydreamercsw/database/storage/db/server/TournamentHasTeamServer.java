 ...
 */
public class TournamentHasTeamServer extends TournamentHasTeam
    ...
    public TournamentHasTeam getEntity() {
        return new TournamentHasTeamJpaController(DataBaseManager.getEntityManagerFactory()).findTournamentHasTeam(getTournamentHasTeamPK());
    }
}
